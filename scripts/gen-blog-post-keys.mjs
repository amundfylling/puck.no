...
const OUT = fileURLToPath(new URL('../functions/lib/blog-post-keys.ts', import.meta.url));
const keys = new Set();
...
writeFileSync(OUT, `/** Generated by scripts/gen-blog-post-keys.mjs — do not edit. */\nexport const BLOG_POST_KEYS = ${JSON.stringify([...keys].sort(), null, 2)} as const;\n`);
console.log(`gen-blog-post-keys: ${keys.size} posts -> functions/lib/blog-post-keys.ts`);
