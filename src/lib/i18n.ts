    ...
    return [
      ...
      { label: 'NEWS', href: p('/blog') },
      {
        ...
        children: [
          ...
          { label: 'WORLD CHAMPIONSHIP 2027 QUALIFICATION', href: p('/kvalifisering-mesterskap') },
        ],
      },
  ...
  return [
    ...
    { label: 'NYHETER', href: '/blog' },
    {
      ...
      children: [
        ...
        { label: 'Kvalifisering VM 2027', href: '/kvalifisering-mesterskap' },
      ],
    },
...
export const ui = {
  ...
  noUpcomingTournaments: {
    no: 'Ingen kommende turneringer annonsert ennå.',
  ...
  onThisPage: { no: 'På denne siden', en: 'On this page' },
  overview: { no: 'Oversikt', en: 'Overview' },
  registration: { no: 'Påmelding', en: 'Registration' },
  ...
  resultsDescription: {
    no: 'Offisielle kampoppsett og resultater publiseres av SportScorpion.',
    en: 'Official schedules and results are published by SportScorpion.',
  },
  openResultsCentre: { no: 'Åpne hele resultatsenteret', en: 'Open full results centre' },
  matchesAndResults: { no: 'Kamper og resultater', en: 'Schedule and results' },
  bracket: { no: 'Sluttspilltre', en: 'Bracket' },
  standings: { no: 'Tabeller', en: 'Standings' },
